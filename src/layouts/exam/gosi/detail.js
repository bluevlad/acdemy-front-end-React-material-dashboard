...
// API
import { getSampleUserDetail, insertSampleUser, updateSampleUser, deleteSampleUser } from "api/exam/gosi";
                                ...
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={12}>
                                        <MDBox display="flex" justifyContent="flex-end">
                                            ...
                                            {rstNo && (
                                                <MDButton variant="gradient" color="error" onClick={handleDelete} sx={{ ml: 1 }}>
                                                    삭제
                                                </MDButton>
                                            )}
                                            <MDButton
