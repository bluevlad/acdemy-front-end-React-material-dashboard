...
export const getMemberFreeOrderList = async (params) => {
  try {
    const response = await superagent.get(`${BASE_API}/freeOrder/getMemberFreeOrderList`).query(params);
...
export const getLearningFormList = async (params) => {
  try {
    const response = await superagent.get(`${BASE_API}/freeOrder/getLearningFormList`).query(params);
    return response.body;
  } catch (error) {
...
export const getLectureListForFreeOrder = async (params) => {
  try {
    const response = await superagent.get(`${BASE_API}/freeOrder/getLectureListForFreeOrder`).query(params);
    return response.body;
  } catch (error) {
...
export const insertFreeOrderMultiple = async (data) => {
  try {
    const response = await superagent.post(`${BASE_API}/freeOrder/insertFreeOrderMultiple`).send(data);
    return response.body;
  } catch (error) {
...
export const getChangeLectureList = async (params) => {
  try {
    const response = await superagent.get(`${BASE_API}/freeOrder/getChangeLectureList`).query(params);
    return response.body;
  } catch (error) {
...
export const getChangeViewDetail = async (params) => {
  try {
    const response = await superagent.get(`${BASE_API}/freeOrder/getChangeViewDetail`).query(params);
    return response.body;
  } catch (error) {
